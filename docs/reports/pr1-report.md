...
## Ronda visual del dueño (ronda 2, 2026-09-03)

**FIX 1**: card "Free Consultation"/"Consulta Gratuita" ELIMINADA de ambos pricing (la consulta gratuita sigue viva en el intro de la página y en los CTAs; en la home nunca hubo card de consulta: verificado). Fila resultante: **SEIS cards en orden ascendente** Focused → Individual → Couples → Monthly 1:1 → Monthly Couples → Burnout, delays de animación reescalonados (0 a .25s). Grid `repeat(6,1fr)` con gap 14px y padding de card 34/26 → 28/18: **render CDP a 1280 y 1440: las seis en UNA línea, alturas idénticas (475/435 EN, 525/480 ES), ancho mínimo de card 188/208px, sin overflow, banner intacto**.

**FIX 2**: Individual Session recupera su descripción original pre-PR1 **byte-idéntica a main** (condiciones: "For burnout, anxiety..." / "Para burnout, ansiedad...", extraída con git show); Focused Session pasa a la descripción única dictada ("For identifying what you are going through, a brief consultation, goal-directed and solution-focused." / ES espejo); el párrafo aclaratorio largo ("A focused session gives you direction..." / "La sesión focal te da dirección...") eliminado de ambos pricing. El OfferCatalog no espejaba esas descripciones (sin resync necesario); la oferta de consulta gratuita nunca existió en schema.

**FIX 3**: card Focused de la HOME (EN/ES) reducida a UN párrafo con el texto dictado (cierra "Goal-directed and solution-focused." / "Dirigida a objetivos y enfocada en soluciones."); párrafo aclaratorio eliminado también de la home. Orden de la vitrina confirmado: Focused → Individual (featured) → Monthly → Burnout (2 pricing-cards + 2 package-cards = 4 slots).

**Suite re-ejecutada (literal)**: composición pricing 6/6 y home 4/4 en orden dictado · restos de card Free/aclaratorio/texto viejo: 0 repo-wide · barrido 75→90 intacto (0 restos) · FAQ 216 intacta, schema=visible 7/7 en ambos pricing · banner 69/69 intacto · JSON-LD 0 err · em dashes 0 · `<em>` 0 · blockquotes 154 · balance HTML OK en las 4 tocadas · render 1280/1440 una línea/alturas parejas/overflow 0. **CANON wa.me = 471** (473 − 2: la card Free de cada pricing llevaba su propio CTA). RESULT: ALL PASS.
